 ...
 */
public class OpenTicketFragment extends BaseFragment implements TicketActivity.TicketPendingListListener {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    @BindView(R.id.recyclerViewTicketOpen)
    RecyclerView recyclerViewTicketOpen;
    ...
    private ArrayList<? extends TicketModel> mParam1;
    private String mParam2;
    private Context mContext;
    private ArrayList<TicketModel> list;
    private TicketOpendAdapter adapter;
    ...
    public static OpenTicketFragment newInstance(List<? extends TicketModel> param1, String param2) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter =new TicketOpendAdapter(mContext);
    }
    ...
    private void init() {
        if(noList)
        {
            showHideView(rlHide,recyclerViewTicketOpen);
        }else
        {
            showHideView(recyclerViewTicketOpen,rlHide);

        }
        LinearLayoutManager linearLayoutManager =new LinearLayoutManager(mContext);
        recyclerViewTicketOpen.setLayoutManager(linearLayoutManager);
        recyclerViewTicketOpen.addOnScrollListener(getRecyclerViewScroll(linearLayoutManager, CommonMethod.TICKET_STATUS_OPEN));

        recyclerViewTicketOpen.setAdapter(adapter);
    ...
    public void onAttach(Context context) {
        ...
        ((TicketActivity) this.mContext).OpenTicketFragmentAttach(this);
    ...
    private void checkNoList() {
        if (noList)
            CommonMethod.showHideItem(rlHide, recyclerViewTicketOpen);
        else
            CommonMethod.showHideItem(recyclerViewTicketOpen, rlHide);
