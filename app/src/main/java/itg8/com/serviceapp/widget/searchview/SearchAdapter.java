...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ResultViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(ResultViewHolder viewHolder, int position) {
        ...
        viewHolder.textbrand.setTypeface((Typeface.create(SearchView.getTextFont(), SearchView.getTextStyle())));
        viewHolder.textbrand.setTextColor(SearchView.getTextColor());
        ...
        if (itemTextLower.contains(key) && !key.isEmpty()) {
            ...
            viewHolder.textbrand.setText(s, TextView.BufferType.SPANNABLE);
        } else {
            viewHolder.text.setText(item.get_text());
            viewHolder.textbrand.setText(item.getTextSecond());
        }
    }
    ...
    public void setSuggestionsList(List<SearchItem> suggestionsList) {
        ...
        mResultList.clear();
        mResultList.addAll(suggestionsList);
    }
    ...
    public class ResultViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ResultViewHolder(View view) {
            ...
            textbrand = (TextView) view.findViewById(R.id.textView_brand_text);
